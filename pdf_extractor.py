...
【出力カラム（5キー必須、仕訳Noは任意）】
1) "仕訳No"（任意：同一伝票内で同一値、3桁ゼロ埋め、例："001","002",...）
2) "伝票日付"（YYYY/M/D、西暦文字列）
3) "借貸区分"（"借方" または "貸方"）
4) "科目名"（日本語で整形。例：「現金（西京普通）」）
5) "金額"（半角数字、正整数）
6) "摘要"（物件名・契約者・備考を含む共通摘要）

【出力例】

[
  {"仕訳No":"001","伝票日付":"2025/2/14","借貸区分":"借方","科目名":"退居敷金","金額":55000,"摘要":"ルベール鷺宮102号 白坂安純様 敷金返還精算"},
  {"仕訳No":"001","伝票日付":"2025/2/14","借貸区分":"借方","科目名":"預り金","金額":41549,"摘要":"ルベール鷺宮102号 白坂安純様 敷金返還精算"},
  {"仕訳No":"001","伝票日付":"2025/2/14","借貸区分":"貸方","科目名":"現金（西京普通）","金額":27249,"摘要":"ルベール鷺宮102号 白坂安純様 敷金返還精算"},
  {"仕訳No":"001","伝票日付":"2025/2/14","借貸区分":"貸方","科目名":"売上（退去営業費）","金額":69300,"摘要":"ルベール鷺宮102号 白坂安純様 敷金返還精算"}
]
